            ...
            <div class="d-flex flex-column">
              ...
              <div class="filter-control p-1 bg-white rounded-3 border">
                <select v-model="currentStatus" class="form-select form-select-sm border-0" 
                  ...
                  <option value="CheckedIn,Confirmed,Completed">Tất cả ca hôm nay</option>
                  <option value="CheckedIn,Confirmed">Ca đang chờ xử lý</option>
                  <option value="Completed">Ca đã hoàn tất</option>
