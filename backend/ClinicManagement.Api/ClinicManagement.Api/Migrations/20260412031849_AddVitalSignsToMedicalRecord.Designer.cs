...
namespace ClinicManagement.Api.Migrations
{
    ...
    [Migration("20260412031849_AddVitalSignsToMedicalRecord")]
    partial class AddVitalSignsToMedicalRecord
    {
            ...
            modelBuilder.Entity("ClinicManagement.Api.Models.User", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            CreatedAt = new DateTime(2026, 4, 12, 3, 18, 49, 570, DateTimeKind.Utc).AddTicks(4651),
                            Email = "",
                            FullName = "",
                            IsActive = true,
                            PasswordHash = "AQAAAAEAACcQAAAAEOZjqIXzhBTr9mHMFZ56URX74fsG0RFh9v0CtIV5jULOYlreUNM7IRVJ2IpvJ3co5A==",
                            PhoneNumber = "",
